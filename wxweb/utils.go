...
func GetSyncKeyListFromJc(jc *config.JsonConfig) (*SyncKeyList, error) {
...
// GetUserInfoFromJc GetUserInfoFromJc
func GetUserInfoFromJc(jc *config.JsonConfig) (*User, error) {
